...
from SAR_DETECTION_DEEPLABV3 import detection
...
for index, row in data.iterrows():
    ...
    processed_csv_path = os.path.join(save_dir_path, r"ship_details")
    row.to_frame().T.to_csv(processed_csv_path, mode='a', index=False, header=not os.path.exists(processed_csv_path))
    ...
    process_spill_data(processed_csv_path,ais_data_path,ports_data_path,save_dir_path)
